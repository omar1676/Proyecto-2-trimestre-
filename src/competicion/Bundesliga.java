...
public class Bundesliga extends Competicion {
    ...
    public Bundesliga() {
        super("Bundesliga 2024/25");
        this.rnd = new Random();

        Club[] clubes = CargadorDatos.crearClubesBundesliga();
    ...
    public Bundesliga(String nombre, Club[] clubes) {
        super(nombre);
        this.rnd = new Random();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Bundesliga)) return false;

        Bundesliga otra = (Bundesliga) o;
