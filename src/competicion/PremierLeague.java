...
public class PremierLeague extends Competicion {
    ...
    public PremierLeague() {
        ...
        Club[] clubes = CargadorDatos.crearClubesPremierLeague();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PremierLeague)) return false;

        PremierLeague otra = (PremierLeague) o;
