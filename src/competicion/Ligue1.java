...
public class Ligue1 extends Competicion {
    ...
    public Ligue1() {
        super("Ligue 1 2024/25");
        this.rnd = new Random();

        Club[] clubes = CargadorDatos.crearClubesLigue1();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Ligue1)) return false;

        Ligue1 otra = (Ligue1) o;
