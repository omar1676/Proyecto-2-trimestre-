...
public class TablaConsola {
    ...
    public static void imprimirTablaCentrada(String titulo, String[] cabeceras, String[][] filas, int anchoConsola) {
        ...
        if (titulo != null) {
            ...
            if (!t.isEmpty()) {
                System.out.println();
                System.out.println(prefijo + tituloDecorado(t, anchoTabla));
            }
        }

        System.out.println(prefijo + repetirCaracter('_', anchoTabla));
        System.out.println(prefijo + construirLinea(anchos, cabeceras, true));
        System.out.println(prefijo + repetirCaracter('_', anchoTabla));
        ...
        for (int r = 0; r < filas.length; r++) {
            ...
            System.out.println(prefijo + construirLinea(anchos, fila, false));
        }
    ...
    public static void imprimirTituloCentrado(String titulo, int anchoConsola) {
        ...
        System.out.println(repetirCaracter(' ', margen) + t);
    }
    ...
    public static void imprimirMenuCentrado(String titulo, String[][] opciones, int anchoConsola, int anchoPanel) {
        ...
        if (titulo != null) {
            ...
            if (!t.isEmpty()) {
                System.out.println();
                System.out.println(prefijo + tituloDecorado(t, anchoPanel));
            }
        }

        System.out.println(prefijo + repetirCaracter('_', anchoPanel));
        System.out.println(prefijo + rellenarDerecha("OP", 4) + " " + "ACCION");
        System.out.println(prefijo + repetirCaracter('_', anchoPanel));
